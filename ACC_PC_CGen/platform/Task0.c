...
extern void MyCCF_myCar_Control_Automatic_calc(void);
...
TASK(Task0)
{
	...
	MyCCF_myCar_Driver_Automatic_calc();
	MyCCF_myCar_Control_Automatic_calc();
	MyCCF_myCar_myCar_Automatic_calc();
