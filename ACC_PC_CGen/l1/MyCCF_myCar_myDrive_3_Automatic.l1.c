...
#include "MyCCF_myCar_myDrive_3_Automatic_private.h"
...
/* L1 class descriptor */
static ASDClassHeader L1_MyCCF_myCar_myDrive_3_Automatic_ClassHeader = {
    0, 0, 15, 0, &_ObjectMethodList, &_ClassMethodList
};
L1_MyCCF_myCar_myDrive_3_Automatic_Class L1_MyCCF_myCar_myDrive_3_Automatic_ClassObj = {{1, {&L1_MyCCF_myCar_myDrive_3_Automatic_ClassHeader}, {0}}};



/* public method */
/* Initializes an instance of this L1 component */
struct L1_MyCCF_myCar_myDrive_3_Automatic_Obj* initInstance_L1_MyCCF_myCar_myDrive_3_Automatic(const struct MyCCF_myCar_myDrive_3_Automatic* self)
{
    struct L1_MyCCF_myCar_myDrive_3_Automatic_Obj* L1_Instance = NULL;

    /* create L1 object and initialize it */
    CREATE_OBJECT (L1_Instance, L1_MyCCF_myCar_myDrive_3_Automatic);
    ...
    L1_Instance->MyTurn_instance = initInstance_L1_MyCCF_myCar_MyTurn_Automatic(&(MyTurn_instance_VAL));
