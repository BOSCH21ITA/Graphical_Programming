 ...
 ******************************************************************************/
#ifndef ESDL_MYCCF_MYCAR_MYCAR_AUTOMATIC_PRIVATE
#define ESDL_MYCCF_MYCAR_MYCAR_AUTOMATIC_PRIVATE

/******************************************************************************
 * BEGIN: DEFINITION OF ACCESS MACROS
 ******************************************************************************/
#define myVehicle_VAL MyCCF_myCar_myCar.myVehicle
#define myVehicle_REF &(MyCCF_myCar_myCar.myVehicle)
#define g_VAL MyCCF_myCar_myCar_CAL_MEM.g
/* ****************************************************************************
 * END: DEFINITION OF ACCESS MACROS
 ******************************************************************************/
#endif /* ESDL_MYCCF_MYCAR_MYCAR_AUTOMATIC_PRIVATE */
